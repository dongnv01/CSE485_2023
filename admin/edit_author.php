...
$stmt_get_author = $pdo->prepare("SELECT * FROM tacgia WHERE ma_tgia = :ma_tgia");
$stmt_get_author->bindParam(':ma_tgia', $ma_tgia, PDO::PARAM_INT);
            ...
            <div class="col-sm">
                ...
                <div class="input-group mt-3 mb-3">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="file" class="form-control" name="hinh_tgia" value = "<?php echo $author['hinh_tgia']; ?>">
                    </div>
