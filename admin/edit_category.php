...
$stmt_get_category = $pdo->prepare("SELECT * FROM theloai WHERE ma_tloai = :ma_tloai");
$stmt_get_category->bindParam(':ma_tloai', $ma_tloai, PDO::PARAM_INT);
$stmt_get_category->execute();
$category = $stmt_get_category->fetch(PDO::FETCH_ASSOC);
?>
